...
namespace DataVerseManager.Models
{
...

    {
        ...
        public double PlaceBet(Team team1, Team team2)
        {
            var (team1Odds, team2Odds) = Betting.GetOdds(team1, team2);
        ...
        public void ShowBettingTable(Team teamA, Team teamB, double margin = 0.06)
        {
            var (oddsA, oddsB) = GetOdds(teamA, teamB);
            double oddsX = Math.Round((oddsA + oddsB) / 2, 2);
